 ...
 * ----------------------------------------------------
 *
 * 0.2.6    - Added 'position' to params to preset the hoverscroll start position
 *
...
(function($) {
    ...
    this.each(function() {
      ...
      if (params.position > 0){
        ...
        if (!params.vertical){
          ...
          element_width = $(this).width() / $(this).find('li').length;
        } else {
          scrollSide = 'scrollTop';
          element_width = $(this).height() / $(this).find('li').length;
        }
        // move to position * width
        listctnr[0][scrollSide] = element_width * params.position;
      }
  ...
  $.fn.hoverscroll.params = {
    ...
    position:       0,          // Start position in list
